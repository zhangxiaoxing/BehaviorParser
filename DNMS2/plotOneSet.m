function plotOneSet(data,measure,tag)
...
subplot('Position',[0.3,0.36,0.7,0.56]);
place=[1 3 6 8]+1;
plotParallel();
...
%         end
        ...
        set(gca,'XTick',place,'XTickLabel',{},'YColor','k','XColor','k','FontSize',10);
        text(place(1),topY(1)-7*sigDY,'Ctrl Off','Color','k','Rotation',40,'FontSize',10,'HorizontalAlignment','right','FontName','Helvetica');
        text(place(2)+0.5,topY(1)-5*sigDY,'Ctrl On','Color','k','Rotation',40,'FontSize',10,'HorizontalAlignment','right','FontName','Helvetica');
        text(place(3),topY(1)-7*sigDY,'VGAT-ChR2 Off','Color','k','Rotation',40,'FontSize',10,'HorizontalAlignment','right','FontName','Helvetica');
        text(place(4)+0.7,topY(1)-5*sigDY,'VGAT-ChR2 On','Color','k','Rotation',40,'FontSize',10,'HorizontalAlignment','right','FontName','Helvetica');
