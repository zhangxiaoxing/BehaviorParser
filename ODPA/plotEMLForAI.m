...
conditions={'NoLaser','Early','Mid','Late'};
conditionTags={'Off','Early','Mid','Late'};

fileName={'EMLSip','EMLSif','EMLSim'};
...
%         groupDesc={'Wild type = ','VGAT-ChR2 = '};
        for group=1:nGrp
            ...
            if min(size(anovaMat))>1
                [p,table,stats]=anova1(anovaMat,{'NoLaser','Early','Mid','Late'},'off');
                pValues(group)=p;
