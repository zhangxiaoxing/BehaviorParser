function plotOneGNG(data,measure,tag)
path(path,'I:\behavior\reports\z');


ctrlOff=cell2mat(data(strcmpi('lightOff',data(:,5)) & strcmpi('ctrl',data(:,6)) & strcmpi('distr',data(:,10)),measure));
ctrlOn=cell2mat(data(strcmpi('lightOn',data(:,5)) & strcmpi('ctrl',data(:,6)) & strcmpi('distr',data(:,10)),measure));
optoOff=cell2mat(data(strcmpi('lightOff',data(:,5)) & strcmpi('ChR2',data(:,6)) & strcmpi('distr',data(:,10)),measure));
optoOn=cell2mat(data(strcmpi('lightOn',data(:,5)) & strcmpi('ChR2',data(:,6)) & strcmpi('distr',data(:,10)),measure));
